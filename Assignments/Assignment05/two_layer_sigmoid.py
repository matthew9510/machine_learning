...
from model_configs import evaluation, sigmoid_two_layer_inference, loss, training, report
...
logits = sigmoid_two_layer_inference(images_placeholder, pixel_count, FLAGS.hidden1, CLASSES, reg_constant=FLAGS.reg_constant) # build model
