...
from model_configs import evaluation, relu_two_layer_inference, loss, training, report
...
flags.DEFINE_float('learning_rate', 0.1, 'Learning rate for the training.')
...
logits = relu_two_layer_inference(images_placeholder, pixel_count, FLAGS.hidden1, CLASSES, reg_constant=FLAGS.reg_constant) # build model
...
with tf.Session() as sess:
    ...
    print("Total time: {:g}".format(total_time))
